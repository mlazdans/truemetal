<div class="Forum-cat" id="attendees{res_id}">Solās ierasties:
	...
	<a href="/attend/{res_id}/" class="button" onclick="Truemetal.Attend('{res_id}'); return false;">Es ar' nāks!!</a>
	<!-- END BLOCK_attend_on -->
	<!-- BEGIN BLOCK_attend_off disabled -->
	<a href="/attend/{res_id}/off/" class="button" onclick="Truemetal.AttendNo('{res_id}'); return false;">Es tomēr nenāks!</a>
