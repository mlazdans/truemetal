		...
		<!-- BEGIN BLOCK_gallery -->
			...
			<tr>
				...
				<td<!-- BEGIN BLOCK_gallery_nogroup disabled --> class="TD-cat" colspan="2"<!-- END BLOCK_gallery_nogroup -->>
					<table cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td nowrap><a name="gal{gal_id}"></a><a href="{module_root}/{gal_id}/">{gal_name}</a></td>
...
<td><a href="{module_root}/view/{gd_id}/"><img src="{module_root}/thumb/{gd_id}/" border="0" class="img-thumb"></a></td>
