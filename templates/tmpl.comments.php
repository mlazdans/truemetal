...
<tr>
	<td class="TD-forum-cat" width="100%"><a name="comment{ac_id}"></a><small><b>{ac_username}</b><!-- BEGIN BLOCK_email disabled -->, <a href="mailto:{ac_useremail}" class="A-small">{ac_useremail}</a><!-- END BLOCK_email -->, {ac_date}</small></td>
	<!-- BEGIN BLOCK_article_comment_vote disabled -->
	<td class="TD-forum-cat {comment_vote_class}" id="artcomVotes{ac_id}">{ac_votes}</td>
	<td class="TD-forum-cat"><a href="{http_root}/vote/up/artcom/{ac_id}/" title="Ōjā!" onclick="artcomVote('{ac_id}', 'up'); return false;">[+]</a></td>
	<td class="TD-forum-cat"><a href="{http_root}/vote/down/artcom/{ac_id}/" title="Dauns..." onclick="artcomVote('{ac_id}', 'down'); return false;">[&ndash;]</a></td>
	...
	<td class="TD-forum-cat"><a href="{module_root}/{art_id}/#comment{ac_id}">Link</a></td>
</tr>
<tr>
	<td colspan="6" width="100%" bgcolor="#444444">{ac_datacompiled}</td>
</tr>
<tr>
...
<input type="hidden" name="ac_referrer" value="{ac_referrer}">
...
<tr>
	<td colspan="2" style="padding-left: 16px; padding-right: 16px;"><textarea name="data[ac_data]" cols="50" rows="10" style="width: 100%;"></textarea></td>
</tr>
<tr>
