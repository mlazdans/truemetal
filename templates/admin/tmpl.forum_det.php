...
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center">
	<tr>
		<td class="TD-cat"><input type="checkbox" name="forum_det_check_all" onClick="checkAll(this.form, this)"></td>
		<td width="100%" class="TD-cat">Foruma komentāri</td>
	</tr>
	...
	<tr>
		...
		<td width="100%" class="{forum_color_class}"><a href="{module_root}/{forum_id}/">{forum_username}</a> {forum_useremail} {forum_userip} {forum_entered},
	...
	<tr>
		<td>&nbsp;</td>
		<td width="100%">{forum_datacompiled}</td>
	</tr>
	<!-- END BLOCK_forum -->
	<tr>
