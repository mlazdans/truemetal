...
<div id="controls">
	<fieldset id="modes">
		<legend>Modes</legend>
		<form id="formAction" method="post" action="<?php echo appendQueryString(CONFIG_URL_IMAGE_UNDO, makeQueryString(array('path'))); ?>">
		<p>
			...
			<button id="actionRotateLeft" class="disabledButton" onclick="return leftRotate();" disabled="disabled"><?php echo IMG_BTN_ROTATE_LEFT; ?></button>
			<button id="actionRotateRight" class="disabledButton" onclick="return rightRotate();" disabled="disabled"><?php echo IMG_BTN_ROTATE_RIGHT; ?></button>
			<button id="actionFlipH" class="disabledButton" onclick="return flipHorizontal();" disabled="disabled"><?php echo IMG_BTN_FLIP_H; ?></button>
			<button id="actionFlipV" class="disabledButton" onclick="return flipVertical();" disabled="disabled"><?php echo IMG_BTN_FLIP_V; ?></button>
			...
			<button id="actionClose" class="button" onclick="return editorClose();"><?php echo IMG_BTN_CLOSE; ?></button>
		</p>
		</form>
	</fieldset>
	<fieldset id="imageInfo">
		<legend id="imageInfoLegend"><?php echo IMG_INFO; ?></legend>
		<form action="<?php echo appendQueryString(CONFIG_URL_IMAGE_SAVE, makeQueryString(array('path'))); ?>" method="post" id="formImageInfo">
...
<div id="imageArea">
	<div id="imageContainer">
		<img src="<?php echo $path; ?>" alt="<?php echo basename($path); ?>" width="<?php echo $imageInfo['width']; ?>" height="<?php echo $imageInfo['height']; ?>" />
	</div>
	<div id="resizeMe">
		<div id="resizeSE"></div>
		<div id="resizeE"></div>
		...
		<div id="resizeSW"></div>
		<div id="resizeS"></div>
		<img id="loading" alt="Loading..." style="display:none;" src="theme/<?php echo CONFIG_THEME_NAME; ?>/images/ajaxLoading.gif" />
	</div>
</div>
...
<div id="windowSaveAs" class="jqmWindow" style="display:none">
	<a href="#" class="jqmClose" id="windowSaveClose"><?php echo LBL_ACTION_CLOSE; ?></a>
		<form id="formSaveAs" action="" method="post">
