...
trait ResVoteEntityTrait {
	...
	function getAll(?AbstractFilter $filters = null): ResVoteCollection {
	...
	function fetch($q): ?ResVoteType {
		// return ResVoteType::fromDBObject(parent::fetch($q));
	...
	// 	if($DATA instanceof ResVoteType){
	...
	function save(array|object $DATA): mixed {
		...
		// 	return parent::save(ResVoteType::toDBObject($DATA));
		// });
	...
	function insert(array|object $DATA): mixed {
		// return $this->savePreprocessor($DATA, function(array|object $DATA){
		// 	return parent::insert(ResVoteType::toDBObject($DATA));
		// });
	...
	function update(int|string|array $ID, array|object $DATA): bool {
		...
		// 	return parent::update($ID, ResVoteType::toDBObject($DATA));
		// }) ?? false;
	}
}
