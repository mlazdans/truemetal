...
trait ViewResOrphansEntityTrait {
	function __construct(){
		parent::__construct();
	}

	function getTableName(): ?string {
		return 'view_res_orphans';
	}
	...
	function getAll(?AbstractFilter $filters = null): ViewResOrphansCollection {
		$col = new ViewResOrphansCollection;
	...
	function fetch($q): ?ViewResOrphansType {
		// return ViewResOrphansType::fromDBObject(parent::fetch($q));
		if($data = parent::fetch($q)){
			return ViewResOrphansType::initFrom($data);
		} else {
			return null;
		}
	}
	...
	// 	if($DATA instanceof ViewResOrphansType){
	...
	function save(array|object $DATA): mixed {
		...
		// 	return parent::save(ViewResOrphansType::toDBObject($DATA));
		// });
	...
	function insert(array|object $DATA): mixed {
		// return $this->savePreprocessor($DATA, function(array|object $DATA){
		// 	return parent::insert(ViewResOrphansType::toDBObject($DATA));
		// });
	...
	function update(int|string|array $ID, array|object $DATA): bool {
		...
		// 	return parent::update($ID, ViewResOrphansType::toDBObject($DATA));
		// }) ?? false;
	}
}
