...
class ViewResCommentDummy extends StricStdObject {
	var int $c_id;
	var int $res_id;
	var ?int $res_resid;
	var int $table_id;
	...
	function real(): ViewResCommentType {
		return ViewResCommentType::initFrom($this);
	}
}
