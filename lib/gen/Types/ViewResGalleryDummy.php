...
class ViewResGalleryDummy extends StricStdObject {
	var int $gal_id;
	var int $gal_ggid;
	var ?int $gg_id;
	var ?string $gg_name;
	...
	function real(): ViewResGalleryType {
		return ViewResGalleryType::initFrom($this);
	}
}
